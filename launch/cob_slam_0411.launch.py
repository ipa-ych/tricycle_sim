...
def generate_launch_description():
    ...
    slam_params_path = os.path.join(get_package_share_directory('tricycle_sim'),'config','mapper_params_cob_0409.yaml')
    ...
    nav2_params_path = os.path.join(get_package_share_directory('tricycle_sim'),'config','navi_cob_drive.yaml')
